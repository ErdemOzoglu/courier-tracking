package com.erdemo.couriertracking.delivery.service;
...
class DistanceCalculatorServiceTest {
    ...
    void shouldDistance_whenLocationsAreSame() {
        ...
        double distance = DistanceCalculatorService.distance(lat1, lat2, lon1, lon2);
    ...
    void shouldDistanceWithHeight_whenLocationsAreSame() {
        ...
        double distance = DistanceCalculatorService.distanceWithHeight(lat1, lat2, lon1, lon2, el1, el2);
